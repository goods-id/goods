...
export interface MarginProps<Theme extends ThemeType = ThemeType> {
  ...
  m?: ResponsiveValue<keyof Required<Theme>['space'] | CSS.Globals, Theme>
  /** Margin Top */
  mt?: ResponsiveValue<keyof Required<Theme>['space'] | CSS.Globals, Theme>
  /** Margin Right */
  mr?: ResponsiveValue<keyof Required<Theme>['space'] | CSS.Globals, Theme>
  /** Margin Bottom */
  mb?: ResponsiveValue<keyof Required<Theme>['space'] | CSS.Globals, Theme>
  /** Margin Left */
  ml?: ResponsiveValue<keyof Required<Theme>['space'] | CSS.Globals, Theme>
  /** Margin Right and Margin Left */
  mx?: ResponsiveValue<keyof Required<Theme>['space'] | CSS.Globals, Theme>
  /** Margin Top and Margin Bottom */
  my?: ResponsiveValue<keyof Required<Theme>['space'] | CSS.Globals, Theme>
}

export interface PaddingProps<Theme extends ThemeType = ThemeType> {
  /** Padding Top, Right, Bottom, and Left */
  p?: ResponsiveValue<keyof Required<Theme>['space'] | CSS.Globals, Theme>
  /** Padding Top */
  pt?: ResponsiveValue<keyof Required<Theme>['space'] | CSS.Globals, Theme>
  /** Padding Right */
  pr?: ResponsiveValue<keyof Required<Theme>['space'] | CSS.Globals, Theme>
  /** Padding Bottom */
  pb?: ResponsiveValue<keyof Required<Theme>['space'] | CSS.Globals, Theme>
  /** Padding Left */
  pl?: ResponsiveValue<keyof Required<Theme>['space'] | CSS.Globals, Theme>
  /** Padding Right and Padding Left */
  px?: ResponsiveValue<keyof Required<Theme>['space'] | CSS.Globals, Theme>
  /** Padding Top and Padding Bottom */
  py?: ResponsiveValue<keyof Required<Theme>['space'] | CSS.Globals, Theme>
}
